...
set( ALGEBRA_PLUGINS_INCLUDE_VC TRUE )
set( ALGEBRA_PLUGINS_INCLUDE_VECMEM TRUE )

# Set up some simple variables for using the package.
set( algebra_plugins_VERSION "0.28" )
set_and_check( algebra_plugins_INCLUDE_DIR
   "${PACKAGE_PREFIX_DIR}/include" )
set_and_check( algebra_plugins_CMAKE_DIR "${PACKAGE_PREFIX_DIR}/lib64/cmake/algebra-plugins-0.28" )
