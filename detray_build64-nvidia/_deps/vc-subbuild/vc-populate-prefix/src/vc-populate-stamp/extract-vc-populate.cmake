...
#
get_filename_component(filename "/mnt/ssd1/ylarbaou/2nd_test/detray2/detray_build64-nvidia/_deps/vc-subbuild/vc-populate-prefix/src/1.4.5.tar.gz" ABSOLUTE)
get_filename_component(directory "/mnt/ssd1/ylarbaou/2nd_test/detray2/detray_build64-nvidia/_deps/vc-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-vc-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-vc-populate${i}")
